...
from flask import send_file, jsonify, Response, render_template
...
def tts_worker():
    ...
    tts = TTS(CONFIG.get("model_name", CONFIG.get("model_name", "tts_models/multilingual/multi-dataset/xtts_v2")))
